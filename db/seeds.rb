...
#   break if index == 40377
#   100.times do |j|
#     displacement = distance(zipcode.center, zipcodes[index + j + 1].center)
#     Neighbor.create(zipcode_1: zipcode.zipcode, zipcode_2: zipcodes[index + j + 1].zipcode, distance: displacement) if displacement <= 24
#   end
# end
